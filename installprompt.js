...
(function () {
  ...
  function show(mode) {
    ...
    // ⚠️ **ข้อความของฝั่งแอปแชตเป็นบรรทัดเดียว ไม่มีหัวข้อ** (เจ้าของสั่งเปลี่ยนคำ 25 ส.ค. 2026)
    //    ของเดิมขึ้นหัวว่า "เปิดในเบราว์เซอร์ก่อนนะครับ" แล้วตามด้วย "ติดตั้งจากในไลน์ไม่ได้ —"
    //    ซึ่งอ่านแล้วเหมือนกำลังบอกว่าเว็บมีปัญหา · เจ้าของขอให้พูดจากมุมของสิ่งที่ผู้ใช้อยากได้แทน
    var head = app ? "" : "ติดตั้งเป็นแอปไหม?";
    var how;
    if (app) {
      how = "ถ้าต้องการจะติดตั้งเป็น app " + app.how + " แล้วค่อยติดตั้ง";
    } else if (mode === "ios") {
    ...
    box.innerHTML =
      '<div class="ib-in">' +
        // ไม่มีหัวข้อ = ให้ข้อความเดียวนั้นอ่านชัดเท่าหัวข้อ ไม่ใช่ตัวเล็กสีจาง
        '<div class="ib-txt">' + (head ? "<b>" + head + "</b>" : "") +
          '<span' + (head ? "" : ' class="ib-one"') + ">" + how + "</span></div>" +
