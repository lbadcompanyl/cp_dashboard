...
// ─────────────────────────────────────────────────────────────────────────────
// [6] 🐞 ป้าย "เครือ CP" ต้องดูจาก **ชื่อเทรนด์** อย่างเดียว ห้ามดูคำค้นที่เกี่ยวข้อง
// เจ้าของส่งภาพมา 27 ส.ค. 2026: เทรนด์ "พิมพิชยา ก๊กรัมย์" (นักวอลเลย์บอล) ติดป้ายเครือ CP
// เพราะคำค้นที่เกี่ยวข้องมีคำว่า "ทรูไอดี" — คนดูถ่ายทอดสดผ่านแอปของทรู
// ไม่ได้แปลว่าข่าวนั้นเป็นข่าวของเครือ (กับดักเดียวกับ "ดูสนุกเกอร์สด" ที่เคยถูกไฮไลต์เป็นอาหาร)
console.log("\n[6] ป้ายเครือ CP ดูจากชื่อเทรนด์เท่านั้น");
{
  ok("นักวอลเลย์บอล + คำค้น 'ทรูไอดี' ต้องไม่ติดป้ายเครือ CP",
     pinScore({ title: "พิมพิชยา ก๊กรัมย์", snippet: "ทรูไอดี", related: [{ term: "ทรูไอดี" }], topics: [] }) === 0);
  ok("ชื่อทีม/คนที่ดังเพราะดูผ่านแอปของทรู ก็ไม่นับ",
     pinScore({ title: "วอลเลย์บอลหญิงไทย", snippet: "", related: [{ term: "ทรูวิชั่นส์" }, { term: "true id" }], topics: [] }) === 0);

  // ✅ ของจริงต้องยังติดป้ายเหมือนเดิม — ชื่อเครืออยู่ในชื่อเทรนด์
  for (const t of ["ทรู คอร์ปอเรชั่น", "ซีพีเอฟ", "เซเว่น อีเลฟเว่น", "แม็คโคร"])
    ok(`ชื่อเครืออยู่ในชื่อเทรนด์ = ยังติดป้าย: ${t}`,
       pinScore({ title: t, snippet: "", related: [], topics: [] }) === 2);

  // ✅ ชื่อลวงยังถูกกันเหมือนเดิม
  ok("ทรูดิจิทัล พาร์ค (สถานที่) ยังไม่นับเป็นเครือ",
     pinScore({ title: "ทรูดิจิทัล พาร์ค", snippet: "", related: [], topics: [] }) === 0);
}
