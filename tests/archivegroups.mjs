...
const CASES = [
  ...
  ["กรมประมงยืนยันมีการลักลอบนำเข้า ชี้แจงปมปลาหมอคางดำ", "ท่าทีภาครัฐ"],
  ...
  ["เปิดปม 11 บริษัทส่งออกปลาสวยงาม ปัญหาตรวจสอบย้อนกลับ", "ปลาสวยงาม"],
  ["ส่องเอเลี่ยนสปีชีส์ในไทย ปลาซัคเกอร์ หอยเชอรี่ ผักตบชวา", "สัตว์ต่างถิ่น"],
...
console.log("\n[8] ชีตติ๊กหมวดมาแล้ว — ต้องยึดชีตก่อนเดา");
{
  ...
  ok("ติ๊ก 7 → เข้าหมวดสัตว์ต่างถิ่น", num("สัตว์ต่างถิ่น") === 1, String(num("สัตว์ต่างถิ่น")));
