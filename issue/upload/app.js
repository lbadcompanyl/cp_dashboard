 ...
 *
 * ทำไมต้องมีหน้า preview: §7.3 ของ ZOCIAL-HANDOFF.md ยังไม่รู้ว่าเวลาในไฟล์เป็นเวลาไทยหรือ UTC
 * แทนที่จะรอคำตอบ → ให้ผู้ใช้ "เห็นเอง" ว่าแถวแรกจะถูกบันทึกเป็นวันไหน แล้วสลับได้ทันที
 */
