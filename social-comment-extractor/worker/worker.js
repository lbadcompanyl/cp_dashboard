...
function systemTwoLens() {
  ...
  return [
    ...
    "ก. **พูดถึงสิ่งที่โพสนำเสนออยู่หรือเปล่า** (โครงการ · สินค้า · การกระทำของเจ้าของโพส)",
    "   ถ้าใช่ ท่าทีต่อสิ่งนั้น = ท่าทีต่อ CP",
    '   ชม → Positive ("โครงการดีมากค่ะ" · "ขอให้โครงการนี้ยั่งยืน" · "อร่อยมาก")',
    "   ตำหนิสิ่งที่โพสนำเสนอ → Negative",
    "ข. **ชี้ตัวคนทำหรือเปล่า** — ผู้นำเข้า · ต้นตอ · คนปล่อยปลา · เจ้าสัว · นายทุน",
    "   ถ้าโพสเป็นเรื่องที่ CP ถูกกล่าวหาอยู่ การด่าคนพวกนี้ = Negative ต่อ CP",
    '   ("ไอ้ตัวต้นเหตุเงียบกริบ" · "คนที่นำเข้ามาลอยตัว" · "รัฐกลัวนายทุน")',
    "",
