...
const CATS = [
  { key: "econ",   label: "💰 เศรษฐกิจ", kw: ["หุ้น","เศรษฐกิจ","จีดีพี","เงินบาท","บาทอ่อน","บาทแข็ง","ดอกเบี้ย","เงินเฟ้อ","ส่งออก","นำเข้า","การค้า","ลงทุน","กำไร","รายได้","ยอดขาย","ตลาดหุ้น","ตลาดหลักทรัพย์","ปันผล","แบงก์","ธนาคาร","ผลประกอบการ","econom","gdp","inflation","export","import","invest","market","stock","finance","earnings","revenue","profit","dividend","baht","bank"] },
  { key: "agri",   label: "🍗 อาหาร/เกษตร", kw: ["หมู","ไก่","ไข่","กุ้ง","ปศุสัตว์","สัตว์ปีก","อาหารสัตว์","เกษตร","ข้าว","ข้าวโพด","มันสำปะหลัง","ประมง","เนื้อ","สุกร","ฟาร์ม","อาหาร","แปรรูปอาหาร","ซีพีเอฟ","เบทาโกร","ไทยฟู้ดส์","ไทยยูเนี่ยน","livestock","pork","poultry","agri","farm","food","feed","shrimp","crop","harvest","cpf","betagro","gfpt"] },
  { key: "retail", label: "🛒 ค้าปลีก/ผู้บริโภค", kw: ["ค้าปลีก","ค้าส่ง","ห้าง","ซูเปอร์","สะดวกซื้อ","ร้านสะดวกซื้อ","ค่าครองชีพ","ผู้บริโภค","อีคอมเมิร์ซ","ห้างสรรพสินค้า","โชห่วย","เซเว่น","แม็คโคร","โลตัส","ซีพี ออลล์","ซีพี แอ็กซ์ตร้า","retail","consumer","e-commerce","ecommerce","mall","convenience","supermarket","wholesale","7-eleven","makro","lotus's","cp all","cp axtra"] },
  { key: "crisis", label: "🚨 วิกฤติ/ภัยพิบัติ", kw: ["โรคระบาด","ระบาด","อหิวาต์","ไข้หวัดนก","asf","โควิด","แผ่นดินไหว","น้ำท่วม","ภัยแล้ง","พายุ","ไฟไหม้","ไฟป่า","สึนามิ","ดินถล่ม","ภัยพิบัติ","อุบัติเหตุ","ฉุกเฉิน","วิกฤต","ภัยธรรมชาติ","ปนเปื้อน","เรียกคืนสินค้า","กักตัว","ล็อกดาวน์","disease","outbreak","pandemic","epidemic","earthquake","quake","flood","drought","storm","typhoon","wildfire","tsunami","disaster","emergency","crisis","recall","contaminat","lockdown","quarantine"] },
  { key: "pol",    label: "🏛️ นโยบาย", kw: ["รัฐบาล","นายก","สภา","ครม","พรรค","เลือกตั้ง","กฎหมาย","นโยบาย","รัฐมนตรี","ภาษี","การเมือง","กกต","แบงก์ชาติ","มาตรการ","กระทรวง","กระทรวงพาณิชย์","กระทรวงเกษตร","ควบคุมราคา","อุดหนุน","ราชกิจจา","govern","policy","election","parliament","minister","cabinet","regulation","tax","law","subsidy","ministry"] },
];
