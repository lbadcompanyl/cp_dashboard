...
const ALERT2_CATS = [
  ...
  { key: "disease", label: "🦠 โรคระบาด/ภัยธรรมชาติ", kw: ["อหิวาต์","asf","ไข้หวัดนก","h5n1","โรคระบาด","โรคกุ้ง","กุ้งตาย","กักกันโรค","ปิดฟาร์ม","swine fever","avian influenza","bird flu","foot and mouth","น้ำท่วม","ภัยแล้ง","เอลนีโญ","ลานีญา","ภัยพิบัติ","เรียกคืน","ปนเปื้อน","สวัสดิภาพสัตว์","ไก่ไร้กรง","cage free","ยาปฏิชีวนะ","แรงงาน"] },
  ...
  { key: "company", label: "🏢 คู่แข่ง/ต่างประเทศ", kw: ["เบทาโกร","ไทยยูเนี่ยน","ไทยฟู้ดส์","betagro","thai union","gfpt","cargill","brf","jbs","สมาคม"] },
];
...
function cardHtml(it, source) {
  return `<a class="card" href="${escapeHtml(it.link)}" target="_blank" rel="noopener">
    ...
    ${source.startsWith("alert") ? `<div class="orig ${it.fromNews ? "n" : "a"}">${it.fromNews ? "📰 มาจากคอลัมน์ข่าว" : "🔔 มาจาก Google Alert"}</div>` : ""}
