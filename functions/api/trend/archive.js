...
const TOPICS = [
  ...
  // 🐟 หัวข้อนี้เจ้าของสั่งให้เก็บ "ทั้งหมวด" ไม่ใช่เฉพาะคำว่า alien species
  // จึงไล่ชื่อชนิดพันธุ์ต่างถิ่นที่เป็นข่าวในไทยไว้ด้วย — ต้องเป็นชุดเดียวกับ extraTerms
  // ใน trend-feeds.config.js ไม่งั้นข่าวจะเข้าคอลัมน์แต่ไม่เข้าชีต (หรือกลับกัน)
  //
  // ⚠️ ใส่ได้เฉพาะคำที่ไม่กำกวม — "ต่างถิ่น" หรือ "รุกราน" เดี่ยวๆ จะดูดข่าวแรงงาน
  // ต่างถิ่นกับข่าวสงครามเข้ามาด้วย จึงเขียนเป็นคำประกอบเสมอ
  { key: "alien", label: "Alien species",
    terms: [
      "เอเลี่ยนสปีชีส์", "เอเลียนสปีชีส์", "เอเลี่ยน สปีชีส์",
      "พันธุ์ต่างถิ่น", "ชนิดพันธุ์รุกราน", "สัตว์ต่างถิ่น", "พืชต่างถิ่น", "ปลาต่างถิ่น",
      "สัตว์น้ำต่างถิ่น", "สัตว์รุกราน", "พืชรุกราน",
      "invasive species", "alien species", "invasive alien species", "non-native species",
