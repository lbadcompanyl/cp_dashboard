...
export default [
  ...
  // เขียนตามที่วางใน Google Alerts ได้เลย รวมทั้งคำที่ขึ้นต้นด้วย `-` (ไม่เอา)
  {
    ...
    extraTerms: [
      "สัตว์ต่างถิ่น",                                   // ใน Alert มีแต่ "ชนิดพันธุ์ต่างถิ่น"
      "เอเลียนสปีชีส์", "เอเลี่ยน สปีชีส์",              // สะกดอีก 2 แบบของคำที่อยู่ใน Alert แล้ว
      "alien species", "invasive species",              // ใน Alert มีแต่ "invasive species Thailand"
    ],
  },
];
