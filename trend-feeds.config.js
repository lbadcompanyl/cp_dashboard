...
export default [
  ...
  // เขียนตามที่วางใน Google Alerts ได้เลย รวมทั้งคำที่ขึ้นต้นด้วย `-` (ไม่เอา)
  {
    ...
    // คำเพิ่มที่ "ไม่ได้อยู่ใน Google Alerts" — ใช้ดึงข่าวจากคอลัมน์ News เข้ามาเท่านั้น
    //
    // ทำไมไม่ใส่ใน query: ช่อง query ของ Google Alerts มีเพดานความยาว (~2,000 ตัวอักษร)
    // ของเดิมเกือบเต็มแล้ว ใส่เพิ่มอีก 30 คำไม่ได้ · คำพวกนี้จึงทำงานกับข่าวที่เราดึงเอง
    // จากคอลัมน์ News (mergeNewsIntoAlert) ซึ่งครอบคลุมสำนักข่าวไทยหลักอยู่แล้ว
    //
    // ⚠️ ต้องเป็นคำที่ "ไม่กำกวม" เท่านั้น — คำอย่าง "ต่างถิ่น" หรือ "รุกราน" เดี่ยวๆ
    // จะไปจับข่าวแรงงานต่างถิ่น/ข่าวสงคราม จึงเขียนเป็นคำประกอบเสมอ
    extraTerms: [
      // ชนิดพันธุ์ต่างถิ่น — คำรวม
      "พันธุ์ต่างถิ่น", "ชนิดพันธุ์รุกราน", "สัตว์ต่างถิ่น", "พืชต่างถิ่น", "ปลาต่างถิ่น",
      "สัตว์น้ำต่างถิ่น", "สัตว์รุกราน", "พืชรุกราน", "เอเลียนสปีชีส์", "เอเลี่ยน สปีชีส์",
      "alien species", "invasive species", "invasive alien species", "non-native species",
      // ปลา
      "ปลาซัคเกอร์", "ปลาเทศบาล", "ปลาอะราไพม่า", "ปลาอาราไพม่า", "arapaima",
      "ปลาช่อนอเมซอน", "ปลาดุกแอฟริกา", "ปลาหมอมายัน", "ปลาหมอบัตเตอร์", "ปลาพีค็อกแบส",
      "อัลลิเกเตอร์ การ์", "alligator gar",
      // หอย · กุ้ง
      "หอยเชอรี่", "หอยทากยักษ์แอฟริกา", "กุ้งเครย์ฟิช", "เครย์ฟิช", "เครฟิช", "crayfish",
      // สัตว์เลื้อยคลาน
      "เต่าแก้มแดง", "อิเกวียน่า", "อีกัวน่า", "iguana", "ตะพาบไต้หวัน",
      // แมลง · หนอน
      "หนอนตัวแบนนิวกินี", "มดคันไฟ", "fire ant",
      // พืช
      "ผักตบชวา", "ไมยราบยักษ์", "หญ้าขจรจบ", "จอกหูหนูยักษ์",
    ],
  },
];
