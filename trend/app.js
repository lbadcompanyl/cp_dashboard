...
if (window.Flags) {
  Flags.init({ onChange: renderAll, cats: NEWS_CATS, ui: "none" }); // ui:"none" = ไม่มีปุ่มลอย 🚩/➕ (ย้ายไป /admin/) · ปุ่ม ⚑ 🗂 บนการ์ดยังอยู่
...
const APP_VER = 81; // = app.js?v= ใน index.html (bump คู่กันเสมอ)
