...
| 2 | **มือถือ** | จอแคบพังไหม? `/trend/` `/ir/` `/issue/` เป็น carousel ปัดซ้ายขวา ไม่ใช่กริด — ของที่กางออกมาในกริดจะดันจนหน้าพัง (เคยเกิดกับกล่องข่าวในคอลัมน์ X มาแล้ว) |
| 3 | **แอปที่ติดตั้งแล้ว** | เครื่องที่ติดตั้งเป็นแอปจะได้ของใหม่ไหม? bump `page-ver` + `?v=` ครบหรือยัง? |
